...
root <- "C:/Users/matte/Desktop/papers/tesi/grafici cap 4/autocorr magnitudo/"
...
for(x in instr){
  ...
  p <- ggacf(ds[[nome]])
  p +
    labs(title = paste(nome," acf"))
  
  
  # ggsave(paste(root, nome, "_autocor.png"), plot = last_plot(), device = NULL, path = NULL,
